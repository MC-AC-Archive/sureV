...
public class SPacketPlayOutPosition extends VPacketPlayOutPosition
{
    ...
    public void accept(final PacketPlayOutPosition packetPlayOutPosition) {
        ...
        this.flags = (Set<TeleportFlag>)((Set)SafeReflection.fetch(SPacketPlayOutPosition.flags_field, packetPlayOutPosition)).stream().map(SPacketPlayOutPosition::lambda$accept$0).collect(Collectors.toSet());
    }
}
