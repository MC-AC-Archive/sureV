...
public class ClientBoundPacket
{
    ...
    private static final String[] lIlIlllllIIIl;
    private static final int[] lIlIlllllIIlI;
    
    private static final int getId(final Class clazz) {
        return (int)((Map)SafeReflection.getLocalField(EnumProtocol.class, ((Map)SafeReflection.getLocalField(EnumProtocol.class, null, ClientBoundPacket.lIlIlllllIIIl[ClientBoundPacket.lIlIlllllIIlI[0]])).get(clazz), ClientBoundPacket.lIlIlllllIIIl[ClientBoundPacket.lIlIlllllIIlI[1]])).get(EnumProtocolDirection.CLIENTBOUND).inverse().get((Object)clazz);
    }
    ...
    private static void lIllIIllIlIlII() {
        (lIlIlllllIIIl = new String[ClientBoundPacket.lIlIlllllIIlI[2]])[ClientBoundPacket.lIlIlllllIIlI[0]] = lIllIIllIlIIll("qxLjiu8YMy4=", "FsDAk");
        ClientBoundPacket.lIlIlllllIIIl[ClientBoundPacket.lIlIlllllIIlI[1]] = lIllIIllIlIIll("Bu8zyTH8QQ8=", "tCevh");
    }
    
    private static String lIllIIllIlIIll(final String s, final String s2) {
        try {
            final SecretKeySpec secretKeySpec = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(s2.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            final Cipher instance = Cipher.getInstance("Blowfish");
            instance.init(ClientBoundPacket.lIlIlllllIIlI[2], secretKeySpec);
    ...
    private static void lIllIIllIlIlIl() {
        (lIlIlllllIIlI = new int[3])[0] = 0;
        ClientBoundPacket.lIlIlllllIIlI[1] = 1;
        ClientBoundPacket.lIlIlllllIIlI[2] = 2;
    }
}
