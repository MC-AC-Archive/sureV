...
public class SPacketPlayInEntityAction extends VPacketPlayInEntityAction
{
    ...
    public void accept(final PacketPlayInEntityAction packetPlayInEntityAction) {
        switch (SPacketPlayInEntityAction$1.$SwitchMap$net$minecraft$server$v1_12_R1$PacketPlayInEntityAction$EnumPlayerAction[packetPlayInEntityAction.b().ordinal()]) {
            case 1: {
