...
public class ClientBoundPacket
{
    ...
    private static final String[] llIlIlIllIIII;
    private static final int[] llIlIllllIIII;
    ...
    private static final int getId(final Class clazz) {
        final Object value = ((Map)SafeReflection.getLocalField(EnumProtocol.class, ((Map)SafeReflection.getLocalField(EnumProtocol.class, null, ClientBoundPacket.llIlIlIllIIII[ClientBoundPacket.llIlIllllIIII[0]])).get(clazz), ClientBoundPacket.llIlIlIllIIII[ClientBoundPacket.llIlIllllIIII[1]])).get(EnumProtocolDirection.CLIENTBOUND);
        final Class<?> class1 = value.getClass();
        final String s = ClientBoundPacket.llIlIlIllIIII[ClientBoundPacket.llIlIllllIIII[2]];
        final Class[] array = new Class[ClientBoundPacket.llIlIllllIIII[1]];
        array[ClientBoundPacket.llIlIllllIIII[0]] = Class.class;
        final Method access = SafeReflection.access(class1, s, array);
        final Object o = value;
        final Object[] array2 = new Object[ClientBoundPacket.llIlIllllIIII[1]];
        array2[ClientBoundPacket.llIlIllllIIII[0]] = clazz;
        return (int)SafeReflection.execute(access, o, array2);
    }
    
    private static void llIllIlIlIlIII() {
        (llIlIlIllIIII = new String[ClientBoundPacket.llIlIllllIIII[3]])[ClientBoundPacket.llIlIllllIIII[0]] = llIllIlIlIIllI("sqbCEwO3npE=", "CTebr");
        ClientBoundPacket.llIlIlIllIIII[ClientBoundPacket.llIlIllllIIII[1]] = llIllIlIlIIllI("7LKvcdaGQJM=", "NAllj");
        ClientBoundPacket.llIlIlIllIIII[ClientBoundPacket.llIlIllllIIII[2]] = llIllIlIlIIlll("NA==", "UhusL");
    }
    
    private static String llIllIlIlIIlll(String s, final String s2) {
        s = new String(Base64.getDecoder().decode(s.getBytes(StandardCharsets.UTF_8)), StandardCharsets.UTF_8);
        final StringBuilder sb = new StringBuilder();
        final char[] charArray = s2.toCharArray();
        int n = ClientBoundPacket.llIlIllllIIII[0];
        final char[] charArray2 = s.toCharArray();
        final int length = charArray2.length;
        int n2 = ClientBoundPacket.llIlIllllIIII[0];
        while (llIlllIIIlIIlI(n2, length)) {
    ...
    private static String llIllIlIlIIllI(final String s, final String s2) {
        try {
            final SecretKeySpec secretKeySpec = new SecretKeySpec(Arrays.copyOf(MessageDigest.getInstance("MD5").digest(s2.getBytes(StandardCharsets.UTF_8)), ClientBoundPacket.llIlIllllIIII[4]), "DES");
            final Cipher instance = Cipher.getInstance("DES");
            instance.init(ClientBoundPacket.llIlIllllIIII[2], secretKeySpec);
    ...
    private static void llIlllIIIlIIIl() {
        (llIlIllllIIII = new int[5])[0] = 0;
        ClientBoundPacket.llIlIllllIIII[1] = 1;
        ClientBoundPacket.llIlIllllIIII[2] = 2;
        ClientBoundPacket.llIlIllllIIII[3] = 3;
        ClientBoundPacket.llIlIllllIIII[4] = 8;
    }
    
    private static boolean llIlllIIIlIIlI(final int n, final int n2) {
        return n < n2;
    }
}
