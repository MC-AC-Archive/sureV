...
public class ClientBoundPacket
{
    ...
    private static final int[] lIIIIIllIlIII;
    
    private static final int getId(final Class clazz) {
        return (int)((Map)SafeReflection.getLocalField(EnumProtocol.class, ((Map)SafeReflection.getLocalField(EnumProtocol.class, null, ClientBoundPacket.lIIIIIllIIIlI[ClientBoundPacket.lIIIIIllIlIII[0]])).get(clazz), ClientBoundPacket.lIIIIIllIIIlI[ClientBoundPacket.lIIIIIllIlIII[1]])).get(EnumProtocolDirection.CLIENTBOUND).inverse().get((Object)clazz);
    }
    ...
    private static void lIIIIllIIllIII() {
        (lIIIIIllIIIlI = new String[ClientBoundPacket.lIIIIIllIlIII[2]])[ClientBoundPacket.lIIIIIllIlIII[0]] = lIIIIllIIlIlll("tDWkXTFlq6k=", "RHAkQ");
        ClientBoundPacket.lIIIIIllIIIlI[ClientBoundPacket.lIIIIIllIlIII[1]] = lIIIIllIIlIlll("m7TTYGeVZ3c=", "Irksz");
    }
    
    private static String lIIIIllIIlIlll(final String s, final String s2) {
        try {
            final SecretKeySpec secretKeySpec = new SecretKeySpec(MessageDigest.getInstance("MD5").digest(s2.getBytes(StandardCharsets.UTF_8)), "Blowfish");
            final Cipher instance = Cipher.getInstance("Blowfish");
            instance.init(ClientBoundPacket.lIIIIIllIlIII[2], secretKeySpec);
    ...
    private static void lIIIIllIIllIll() {
        (lIIIIIllIlIII = new int[3])[0] = 0;
        ClientBoundPacket.lIIIIIllIlIII[1] = 1;
        ClientBoundPacket.lIIIIIllIlIII[2] = 2;
    }
}
